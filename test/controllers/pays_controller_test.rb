...
class PaysControllerTest < ActionController::TestCase
  ...
  test "should create pay" do
    assert_difference('Pay.count') do
      post :create, pay: { apoderado_id: @pay.apoderado_id, fecha: @pay.fecha, mes: @pay.mes, monto: @pay.monto }
    end
  ...
  test "should update pay" do
    patch :update, id: @pay, pay: { apoderado_id: @pay.apoderado_id, fecha: @pay.fecha, mes: @pay.mes, monto: @pay.monto }
    assert_redirected_to pay_path(assigns(:pay))
  end
