...
class RegistriesControllerTest < ActionController::TestCase
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post :create, registry: { date: @registry.date, fecha: @registry.fecha, mensaje: @registry.mensaje, nombre: @registry.nombre, reference: @registry.reference, string: @registry.string, string: @registry.string, van: @registry.van }
    end
  ...
  test "should update registry" do
    patch :update, id: @registry, registry: { date: @registry.date, fecha: @registry.fecha, mensaje: @registry.mensaje, nombre: @registry.nombre, reference: @registry.reference, string: @registry.string, string: @registry.string, van: @registry.van }
    assert_redirected_to registry_path(assigns(:registry))
  end
