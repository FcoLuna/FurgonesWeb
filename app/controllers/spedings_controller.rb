class SpendingsController < ApplicationController
  ...
  # GET /spendings.json
  def index
    @spendings = Spending.paginate(:page => params[:page], :per_page => 10)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @spending.save
        format.html { redirect_to @spending, notice: 'Gasto regustrado con exito.' }
  ...
  def update
    respond_to do |format|
      if @spending.update(spending_params)
        format.html { redirect_to @spending, notice: 'Gasto editado con Exito.' }
  ...
  private
    ...
    def spending_params
      params.require(:spending).permit(:nombre, :monto, :van_id)
    end
end
